...
function Card({ title, right, children, className = "" }) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
    "section",
    {
      ...
      children: [
        (title || right) && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex items-center justify-between gap-3", children: [
          title ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { className: "font-medium", children: title }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {}),
          right
        ] }),
        children
      ]
...
function Toggle({ checked, onChange, label }) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    "button",
    {
      ...
      className: `h-6 w-11 shrink-0 rounded-full transition ${checked ? "bg-sky-500" : "bg-zinc-700"}`,
      children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: `block h-5 w-5 rounded-full bg-white transition ${checked ? "translate-x-5" : "translate-x-0.5"}` })
    }
  );
}
var TONES = {
...
function Button({ children, onClick, disabled, tone = "default", className = "" }) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    "button",
    {
      onClick,
...
function Segmented({ value, onChange, options }) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "flex rounded-lg border border-zinc-700 p-0.5 text-sm", children: options.map((o) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    "button",
    {
      onClick: () => onChange(o.value),
      className: `flex-1 rounded-md px-3 py-1.5 transition ${value === o.value ? "bg-zinc-700 text-zinc-100" : "text-zinc-400 hover:text-zinc-200"}`,
      children: o.label
    },
    o.value
  )) });
...
function NumberField({ label, value, onChange, min, max, step = 1, suffix }) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { className: "flex items-center justify-between gap-3 text-sm", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "text-zinc-400", children: label }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "flex items-center gap-2", children: [
      ...
      suffix && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "w-6 text-zinc-500", children: suffix })
    ] })
  ] });
}
...
function Slider({ label, value, min, max, step, display, onChange }) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { className: "block text-sm", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "flex justify-between", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "text-zinc-400", children: label }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "tabular-nums text-zinc-300", children: display })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      "input",
      {
...
function ConfirmDialog({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    "div",
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "w-full max-w-sm rounded-2xl border border-zinc-700 bg-zinc-900 p-5", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { className: "font-medium", children: title }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "mt-2 text-sm text-zinc-400", children: consequence }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "mt-5 flex gap-2", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, { onClick: onCancel, className: "flex-1", children: "Cancel" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, { onClick: onConfirm, tone, className: "flex-1", children: confirmLabel })
        ] })
      ] })
    }
  );
...
function Section({
  ...
  const [open, setOpen] = (0, import_react.useState)(!collapsible);
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { className: "flex flex-col gap-5", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex items-baseline justify-between border-b\r\n                      border-zinc-800 pb-2", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { className: "text-xs font-medium uppercase tracking-widest\r\n                         text-zinc-400", children: title }),
        subtitle && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "mt-0.5 text-xs text-zinc-500", children: subtitle })
      ] }),
    ...
    open ? children : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "-mt-2 text-xs text-zinc-500", children: summary })
  ] });
}
...
function useCameras() {
  ...
  const refresh = (0, import_react2.useCallback)(async () => {
    const r = await fetch("/api/setup/camera", { cache: "no-store" }).catch(() => null);
...
function CameraPanel({ selected, onSelect, info, refresh }) {
  const [shotAt, setShotAt] = (0, import_react2.useState)(null);
  const [waiting, setWaiting] = (0, import_react2.useState)(false);
  const polls = (0, import_react2.useRef)(0);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "space-y-4", children: [
    found ? /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
      cameras.length > 1 ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
        Select,
        {
          label: "Which camera is pointed at the sky?",
          value: active,
          onChange: onSelect,
          options: cameras.map((c) => ({ value: c.camera_id, label: c.label }))
        }
      ) : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "rounded-xl border border-zinc-800 bg-zinc-900 p-4\n                          text-emerald-300", children: cameras[0]?.label || info.detected }),
      shotAt && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("figure", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          "img",
          {
            src: `/api/setup/camera/shot?t=${shotAt}`,
            alt: "Test shot",
            className: "w-full rounded-lg bg-zinc-800"
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("figcaption", { className: "mt-1 text-xs text-zinc-500", children: "A real frame, taken just now. It isn\u2019t saved to your night." })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Button, { onClick: takeShot, disabled: waiting, className: "w-full", children: waiting ? "Taking a shot\u2026" : shotAt ? "Retake" : "Take a test shot" })
    ] }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "space-y-3 text-sm text-zinc-400", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { children: "No camera detected. Worth checking, in this order:" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("ul", { className: "list-disc space-y-2 pl-5", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("li", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("b", { children: "Pull the power for 15 seconds." }),
          " Not a reboot \u2014 a full cold start, plug out. A warm reboot does not drain the sensor\u2019s regulator and some modules only come up after one. This is first because it is the cheapest thing to try and, on this project\u2019s own hardware, the thing that turned out to be wrong twice."
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("li", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("b", { children: "Ribbon cable:" }),
          " contacts the right way round at",
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("i", { children: " both" }),
          " ends. It is easy to get right at one and wrong at the other."
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("li", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("b", { children: "USB camera:" }),
          " seated firmly, and on the official power supply. Underpowering a USB3 camera looks like a missing camera."
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Button, { onClick: refresh, className: "w-full", children: "Scan again" })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(AddCamera, { found: !!found, onChanged: refresh })
  ] });
}
function AddCamera({ found, onChanged }) {
  const [open, setOpen] = (0, import_react2.useState)(!found);
  if (!open) {
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
      "button",
      {
        ...
        children: found ? "Add another camera" : "My camera isn\u2019t being detected"
      }
    );
  }
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "space-y-4", children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(DeclareSensor, {}),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ZwoSupport, { onChanged })
  ] });
}
function DeclareSensor() {
  const [sensors, setSensors] = (0, import_react2.useState)([]);
  const [sensor, setSensor] = (0, import_react2.useState)("imx477");
  const [state, setState] = (0, import_react2.useState)("");
  (0, import_react2.useEffect)(() => {
    fetch("/api/setup/camera/sensors").then((r) => r.json()).then((b) => setSensors(b.sensors ?? [])).catch(() => {
    });
  }, []);
  const enable = async () => {
    setState("working");
  ...
  if (state === "rebooting") return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(WaitingForReboot, { sensor });
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "space-y-3 rounded-xl border border-zinc-800 bg-zinc-900 p-4", children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "text-sm text-zinc-300", children: "Raspberry Pi camera module" }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "text-sm text-zinc-400", children: "Some cameras \u2014 most third-party HQ/IMX477 boards among them \u2014 can\u2019t be detected automatically, because that relies on a chip they don\u2019t carry. Pick yours and Skylapse will tell the Pi about it directly." }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
      Select,
      {
        label: "Sensor",
        value: sensor,
        onChange: setSensor,
        options: sensors.length ? sensors : [{ value: "imx477", label: "HQ Camera / IMX477" }]
      }
    ),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("p", { className: "rounded-lg bg-zinc-800/60 p-3 text-xs text-zinc-400", children: [
      "The camera restarts to load the driver, so your phone will drop off its Wi-Fi for a minute. Don\u2019t close this page \u2014 it picks up on its own.",
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("b", { className: "mt-1 block text-zinc-300", children: "Have the power lead handy." }),
      "On most boards the restart is not enough on its own and you will need to pull the power once \u2014 the next screen says when."
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
      Button,
      {
        ...
        onClick: enable,
        children: state === "working" ? "Saving\u2026" : "Enable and restart"
      }
    ),
    state === "failed" && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "text-sm text-red-400", children: "Couldn\u2019t write the boot configuration." }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "text-xs text-zinc-500", children: "Harmless to get wrong \u2014 pick another and try again. The original configuration is kept as config.txt.skylapse-backup." })
  ] });
}
function ZwoSupport({ onChanged }) {
  const [zwo, setZwo] = (0, import_react2.useState)(null);
  const [accepted, setAccepted] = (0, import_react2.useState)(false);
  const [state, setState] = (0, import_react2.useState)("");
  ...
  const install = async () => {
    ...
    if (r?.ok) {
      ...
      setError(detail?.detail || "Couldn\u2019t install it. Check the camera\u2019s internet connection and try again.");
      setState("");
    }
  };
  if (!zwo) return null;
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "space-y-3 rounded-xl border border-zinc-800 bg-zinc-900 p-4", children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "text-sm text-zinc-300", children: "ZWO ASI camera (USB)" }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("p", { className: "rounded-lg border border-amber-700/60 bg-amber-950/40 p-3\n                    text-xs text-amber-200/90", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("b", { className: "text-amber-300", children: "Best effort, and not guaranteed." }),
      " ",
      "Skylapse is built and tested for Raspberry Pi camera modules \u2014 the HQ camera above all. ZWO support is second: it needs a vendor library that can\u2019t be shipped with Skylapse, it has only been verified on one model (ASI676MC), and it may not work with your camera at all. If you are choosing a camera for this, choose a Pi one."
    ] }),
    !zwo.supported ? /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("p", { className: "text-sm text-zinc-400", children: [
      "Not available on this system (",
      zwo.machine,
      ") \u2014 it needs 64-bit Raspberry Pi OS."
    ] }) : zwo.installed ? /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("p", { className: "text-sm text-emerald-300", children: [
        "ZWO support installed (SDK ",
        zwo.version,
        ")."
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "text-xs text-zinc-500", children: "Plug the camera in and use \u201CScan again\u201D above. If it still isn\u2019t found, a full power cycle is the usual fix \u2014 a USB3 camera on an underpowered supply looks exactly like a missing one." })
    ] }) : state === "done" ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "text-sm text-emerald-300", children: "Installed. Plug the camera in and scan again." }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "text-sm text-zinc-400", children: "Skylapse can download ZWO\u2019s camera library for you \u2014 about 4 MB, so the camera needs to be on a network with internet access. No terminal, no reboot." }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("label", { className: "flex items-start gap-3 text-sm text-zinc-400", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          "input",
          {
            type: "checkbox",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
            "a",
            {
              href: zwo.license_url,
              target: "_blank",
              rel: "noreferrer",
              className: "text-sky-400 underline",
              children: "ZWO\u2019s licence"
            }
          ),
          " ",
          "for their SDK."
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
        Button,
        {
          tone: "accent",
          className: "w-full",
          disabled: !accepted || state === "working",
          onClick: install,
          children: state === "working" ? "Downloading\u2026" : "Install ZWO support"
        }
      ),
      !zwo.bindings && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("p", { className: "text-xs text-amber-400", children: [
        "The Python bindings are missing from this install too, so the driver won\u2019t load even once the library is in place. Reinstall with the ",
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("code", { children: "zwo" }),
        " extra."
      ] })
    ] }),
    error && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "text-sm text-red-400", children: error })
  ] });
}
function WaitingForReboot({ sensor }) {
  const [seconds, setSeconds] = (0, import_react2.useState)(0);
  const [found, setFound] = (0, import_react2.useState)(null);
  (0, import_react2.useEffect)(() => {
    const tick = setInterval(() => setSeconds((s) => s + 1), 1e3);
  ...
  if (found) {
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "rounded-xl border border-emerald-800 bg-emerald-950 p-4", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("p", { className: "text-emerald-300", children: [
        "Camera found: ",
        found
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "mt-2 text-sm text-zinc-400", children: "Take a test shot to make sure it is really working, not just detected." })
    ] });
  }
  const coldStart = seconds > 45;
  const slow = seconds > 150;
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "rounded-xl border border-zinc-800 bg-zinc-900 p-4", children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "flex items-center gap-3", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "h-4 w-4 shrink-0 animate-spin rounded-full\n                         border-2 border-sky-500 border-t-transparent" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("p", { className: "text-sky-300", children: [
        "Restarting with ",
        sensor,
        " enabled\u2026 ",
        seconds,
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("ol", { className: "mt-4 space-y-2 text-sm text-zinc-400", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("li", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("b", { className: "text-zinc-300", children: "Don\u2019t reload this page." }),
        " It is still working, and reloading now is what shows you a blank one."
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("li", { children: [
        "Your phone will drop off the camera\u2019s Wi-Fi while it restarts.",
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("b", { className: "text-zinc-300", children: " Rejoin it" }),
        " when it comes back and this page carries on by itself."
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("li", { children: "Usually about a minute. Nothing you answered is lost." })
    ] }),
    coldStart && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "mt-4 rounded-lg border border-sky-800 bg-sky-950 p-3", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("p", { className: "text-sm text-sky-200", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("b", { className: "text-sky-100", children: "Now pull the power for 15 seconds" }),
        ", then plug it back in."
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "mt-2 text-xs text-sky-200/80", children: "This is normal and it is usually the step that works. Restarting applies the setting, but it does not cut power to the sensor, and most camera boards will not come up until it has actually been off. Unplug at the wall or at the Pi \u2014 either is fine." }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "mt-2 text-xs text-sky-200/80", children: "Leave this page open while you do it. It keeps checking, and moves on by itself the moment the camera answers." })
    ] }),
    slow && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "mt-4 rounded-lg bg-amber-950 p-3 text-sm text-amber-300", children: "Still nothing. If you have already power-cycled it, check your phone is back on the camera\u2019s network, then reload this page \u2014 nothing is lost either way, since your answers are kept on the camera rather than here. A camera that never appears after a cold start is usually the ribbon cable, or the wrong sensor picked, and both are safe to try again." })
  ] });
}
...
function SettingsScreen({ showToast, storage }) {
  const [cfg, setCfg] = (0, import_react3.useState)(null);
  const [topic, setTopic] = (0, import_react3.useState)(null);
  const [testResult, setTestResult] = (0, import_react3.useState)(null);
  const [cameraInfo, refreshCameras] = useCameras();
  const reloadConfig = (0, import_react3.useCallback)(() => {
  ...
  const saveCamera = (id, patch) => {
    const cameras2 = { ...cfg.cameras, [id]: { ...cfg.cameras[id], ...patch } };
    return save({ cameras: cameras2 }, { ...cfg, cameras: cameras2 });
  };
  const saveProfile = (id, period, patch) => saveCamera(id, { [period]: { ...cfg.cameras[id][period], ...patch } });
  const saveNotifications = (notifications) => save({ notifications }, { ...cfg, notifications });
  ...
  const activeName = cfg.cameras?.[cfg.active_camera]?.label || cfg.cameras?.[cfg.active_camera]?.model || cameras[0]?.[1]?.label || cameras[0]?.[1]?.model || cameras[0]?.[0] || "";
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "mt-6 flex flex-col gap-8", children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
      Section,
      {
        title: "This camera",
        subtitle: activeName ? `Imaging settings for ${activeName}` : "Imaging settings, once a camera has been seen",
        children: cameras.map(([id, cam]) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
          CameraSettings,
          {
            id,
            cam,
    ...
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
      Section,
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(Card, { title: "Cameras", children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "mt-1 text-sm text-zinc-400", children: cameras.length > 1 ? "Which camera is pointed at the sky, and how to add another." : "What\u2019s attached, a test shot to prove it works, and how to add a camera the Pi can\u2019t find by itself." }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "mt-4", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
            CameraPanel,
            {
              info: cameraInfo,
              refresh: refreshCameras,
              selected: cfg.active_camera,
              onSelect: (active_camera) => save({ active_camera }, { ...cfg, active_camera })
            }
          ) }),
          cameras.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "mt-4 text-xs text-zinc-500", children: "Capture settings appear below once a camera has been seen." })
        ] })
      }
    ),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
      Section,
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
          ...
          {
            title: "Notifications",
            right: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
              Toggle,
              {
                checked: n.enabled,
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "mt-1 text-sm text-zinc-400", children: "Alerts on your phone via the free ntfy app. Off by default." }),
              n.enabled && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "mt-4 space-y-3", children: [
                !n.ntfy_topic && !topic ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Button, { onClick: setupNtfy, className: "w-full", children: "Set up phone alerts" }) : /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "rounded-lg bg-zinc-800/60 p-3 text-sm", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "text-zinc-400", children: "In the ntfy app, subscribe to topic:" }),
                  /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("code", { className: "text-sky-400", children: topic?.topic ?? n.ntfy_topic })
                ] }),
                /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("ul", { className: "divide-y divide-zinc-800 rounded-lg border border-zinc-800", children: Object.entries(EVENT_LABELS).map(([key, label]) => /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
                  "li",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
                        ...
                        {
                          type: "checkbox",
                          checked: n.events?.[key] ?? false,
                          onChange: (e) => saveNotifications({
                            ...n,
                            events: { ...n.events, [key]: e.target.checked }
                          })
                        }
                      )
                    ]
                ...
                /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Button, { onClick: sendTest, className: "w-full", children: "Send test notification" }),
                testResult && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "text-sm text-zinc-400", children: testResult })
              ] })
            ]
          }
        )
    ...
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
      Section,
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(NetworkCard, { showToast }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(RemoteCard, {}),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(SecurityCard, { showToast }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
            UpdateCard,
            {
              cfg,
              showToast,
              onChannel: (channel) => save(
                { updates: { ...cfg.updates, channel } },
                { ...cfg, updates: { ...cfg.updates, channel } }
              ),
              onAutoCheck: (auto_check) => save(
                { updates: { ...cfg.updates, auto_check } },
                { ...cfg, updates: { ...cfg.updates, auto_check } }
              )
            }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(Card, { title: "Backup", children: [
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "mt-1 text-sm text-zinc-400", children: "Your settings as a YAML file. SD cards fail; keeping a copy elsewhere turns a rebuild into a restore. A copy is also written to any USB drive you export to." }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
              "a",
              {
            ...
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "mt-2 text-xs text-zinc-500", children: "The hotspot password is redacted from this download." })
          ] })
        ]
      }
    )
...
function RemoteCard() {
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
    ...
    {
      title: "Remote access",
      right: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "rounded-full bg-zinc-800 px-2.5 py-1 text-xs\r\n                              text-zinc-400", children: "Coming soon" }),
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "mt-1 text-sm text-zinc-500", children: "View your camera from anywhere through your own free Tailscale account, with no port forwarding and nothing of yours on anybody\u2019s server." }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "mt-3 text-sm text-zinc-500", children: "It isn\u2019t finished. Rather than leave a button here that doesn\u2019t work, it\u2019s switched off until it does \u2014 everything else on this page is unaffected, and the camera has never needed the internet to run." })
      ]
    }
  );
}
...
function NetworkCard({ showToast }) {
  const [net, setNet] = (0, import_react3.useState)(null);
  const [choice, setChoice] = (0, import_react3.useState)("hotspot");
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(Card, { title: "Network", children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("p", { className: "mt-1 text-sm text-zinc-400", children: [
      ap ? `The camera is its own access point, ${net.hotspot_ssid}.` : net.ssid ? `Connected to ${net.ssid}.` : "Not connected to Wi-Fi.",
      net.remaining_s != null && ap && " It returns to Wi-Fi when the time is up."
    ] }),
    ap ? /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("p", { className: "mt-3 text-sm text-zinc-500", children: [
        net.clients > 0 ? `${net.clients} device${net.clients > 1 ? "s" : ""} connected.` : "No devices connected yet.",
        " ",
        "Join ",
        net.hotspot_ssid,
      ...
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
        Button,
        {
          ...
          children: busy ? "Switching\u2026" : "Switch back to Wi-Fi"
        }
      )
    ] }) : /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "mt-4 space-y-3", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
        Select,
        {
          label: "Stay in access-point mode for",
          value: choice,
          onChange: setChoice,
          options: AP_DURATIONS
        }
      ),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
        Button,
        {
          ...
          className: "w-full",
          disabled: busy,
          onClick: () => setPending(choice === "hotspot" ? { mode: "hotspot" } : { mode: "hotspot_timed", minutes: Number(choice) }),
          children: busy ? "Switching\u2026" : "Switch to access-point mode"
        }
      )
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "mt-5 border-t border-zinc-800 pt-4", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
        Select,
        {
          label: "Wi-Fi country",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "mt-2 text-xs text-zinc-500", children: "Radio regulations differ by country. Until this is set the camera may not transmit at all, including the network it serves for setup." })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
      ConfirmDialog,
      {
        open: !!pending,
        title: pending?.mode === "auto" ? "Switch back to Wi-Fi?" : "Switch to access-point mode?",
        consequence: pending?.mode === "auto" ? `The ${net.hotspot_ssid} network will disappear and any device on it \u2014 including this one \u2014 will be disconnected. The camera rejoins your Wi-Fi within about a minute.` : `This device will lose its connection to the camera. To get back, join the ${net.hotspot_ssid} network from your Wi-Fi settings and open http://10.42.0.1`,
...
function CameraSettings({ id, cam, storage, onCamera, onProfile }) {
  const [period, setPeriod] = (0, import_react3.useState)("night");
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
      ...
      {
        title: "Capture",
        right: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "text-sm text-zinc-500", children: cam.label || id }),
        children: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "mt-3 space-y-4", children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { children: [
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "mb-2 text-sm text-zinc-400", children: "Capture" }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
              Segmented,
              {
            ...
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "mt-2 text-xs text-zinc-500", children: "Night only pauses capture while the sun is up and picks up again at dusk. Twilight still captures. Timelapse rendering, alerts and focus assist keep working either way." })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "rounded-xl border border-zinc-700 bg-zinc-900/60 p-3", children: [
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "mb-2 text-sm text-zinc-300", children: "Which half of the day are you setting up?" }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Segmented, { value: period, onChange: setPeriod, options: PERIOD_OPTIONS }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("p", { className: "mt-2 text-xs text-zinc-500", children: [
              "Day and night keep ",
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("b", { className: "text-zinc-400", children: "separate" }),
              " ",
              "settings \u2014 gap, exposure and brightness below all belong to",
              " ",
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("b", { className: "text-zinc-400", children: period }),
              " only, and changing them leaves the other alone. Twilight uses the night settings, since that is when the interesting sky starts."
            ] })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
            NumberField,
          ...
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "-mt-1 text-xs text-zinc-500", children: "Measured from the end of one frame to the start of the next, so it stays predictable as auto-exposure changes the exposure." }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
            Segmented,
            {
          ...
          manual ? /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "space-y-4 rounded-xl bg-zinc-800/40 p-4", children: [
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
              NumberField,
              {
                label: "Exposure",
            ...
            /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("label", { className: "flex items-start justify-between gap-3 text-sm", children: [
              /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { children: [
                /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "text-zinc-300", children: "Safety stop" }),
                /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "mt-1 block text-xs text-zinc-500", children: "Pause capture at daylight or after repeated near-saturated frames. Protects a tracked sensor from a forgotten dawn." })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
                "input",
                {
                  ...
                  onChange: (e) => onProfile(period, { manual_safety_stop: e.target.checked })
                }
              )
            ] })
          ] }) : (
            ...
            /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "space-y-4 rounded-xl bg-zinc-800/40 p-4", children: [
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
                ExposureNudge,
                {
                  ...
                  period,
                  cameraId: id,
                  onChange: (target_brightness) => onProfile(period, { target_brightness })
                }
              ),
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
                AdvancedExposure,
    ...
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
      Card,
      {
        ...
        right: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
          Toggle,
          {
            checked: cam.timelapse?.auto_render ?? true,
            label: "Auto-render at dawn",
            onChange: (auto_render) => onCamera({ timelapse: { ...cam.timelapse, auto_render } })
          }
        ),
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "mt-1 text-sm text-zinc-400", children: "Render last night automatically at dawn." }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "mt-4 space-y-3", children: [
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
              NumberField,
              {
                ...
                onChange: (clip_seconds) => onCamera({ timelapse: { ...cam.timelapse, clip_seconds } })
              }
            ),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
              Select,
              {
                label: "Quality",
                value: cam.timelapse?.quality ?? "high",
                options: QUALITY_OPTIONS,
                onChange: (quality) => onCamera({ timelapse: { ...cam.timelapse, quality } })
              }
            ),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
              Select,
              {
                label: "Resolution",
                value: cam.timelapse?.resolution ?? "4k",
                options: TIMELAPSE_RES_OPTIONS,
                onChange: (resolution) => onCamera({ timelapse: { ...cam.timelapse, resolution } })
              }
            ),
            (cam.timelapse?.resolution ?? "4k") === "full" && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "rounded-lg bg-amber-950 p-3 text-sm text-amber-300", children: "Full sensor resolution encodes to h264 level 6.0, which phone and browser hardware decoders refuse \u2014 measured on this rig, a native render played back as garbage in both VLC and the browser while being a perfectly valid file. It is also several times larger and slower to render. Use it only if you are editing the result on a desktop." }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(RenderPlan, { cameraId: id }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "text-xs text-zinc-500", children: "Resolution is a pixel budget, not a width, so it works out the same on a square sensor as on a wide one." })
          ] })
        ]
      }
    ),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(WhiteBalanceCard, { id, cam, onCamera }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
      RawCard,
      {
        raw: cam.raw ?? {},
    ...
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
      Card,
      {
        ...
        right: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
          Toggle,
          {
            checked: cam.overlay ?? false,
            label: "Burn overlay into JPEGs",
            onChange: (overlay) => onCamera({ overlay })
          }
        ),
        children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "mt-1 text-sm text-zinc-400", children: "Burn timestamp, exposure, gain and sensor temperature into the corner of each JPEG. RAW/DNG files are never touched." })
      }
    )
  ] });
}
function SecurityCard({ showToast }) {
  ...
  const [next, setNext] = (0, import_react3.useState)("");
  const [busy, setBusy] = (0, import_react3.useState)(false);
  const refresh = (0, import_react3.useCallback)(() => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(Card, { title: "Security", children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("p", { className: "mt-1 text-sm text-zinc-400", children: [
      state.password_set ? "This camera asks for a password." : "Anyone on your network can open this page and change settings.",
      " ",
      "One shared password, like a router\u2019s admin page \u2014 it defends against your local network, not the internet, which the camera is never exposed to either way."
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "mt-4 space-y-3", children: [
      state.password_set && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
        "input",
        {
          type: "password",
          value: current,
      ...
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
        Button,
        {
          ...
          children: state.password_set ? "Change password" : "Set password"
        }
      ),
      state.password_set && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("label", { className: "flex items-start gap-3 text-sm", children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
            Toggle,
            {
              checked: state.public_live_view,
              label: "Public live view",
              onChange: (public_live_view) => send({ current, public_live_view }, "Saved")
            }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "text-zinc-400", children: "Show the latest frame without a password. Settings and controls stay locked." })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
          Button,
          {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "text-xs text-zinc-500", children: "Forgotten it? Clear the entry in /etc/skylapse/config.yaml over SSH. It never needs a reflash." })
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "mt-5 border-t border-zinc-800 pt-4", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
        Button,
        {
          ...
          children: "Run setup again"
        }
      ),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "mt-2 text-xs text-zinc-500", children: "Walks the first-run wizard with your current settings filled in. Nothing is cleared." })
    ] })
  ] });
}
var WB_MIN = 0.5;
var WB_MAX = 3;
var WB_PREVIEW_DEBOUNCE_MS = 250;
function WhiteBalanceCard({ id, cam, onCamera }) {
  const applied = { r: cam.wb_r ?? 1, b: cam.wb_b ?? 1 };
  const [pending, setPending] = (0, import_react3.useState)(applied);
  const [preview, setPreview] = (0, import_react3.useState)(pending);
  const [suggestion, setSuggestion] = (0, import_react3.useState)(null);
  const [noFrame, setNoFrame] = (0, import_react3.useState)(false);
  (0, import_react3.useEffect)(() => {
    const t = setTimeout(() => setPreview(pending), WB_PREVIEW_DEBOUNCE_MS);
    return () => clearTimeout(t);
  }, [pending.r, pending.b]);
  const dirty = pending.r !== applied.r || pending.b !== applied.b;
  const neutral = pending.r === 1 && pending.b === 1;
  const autoSeed = async () => {
    const r = await fetch(`/api/wb/suggest?camera_id=${encodeURIComponent(id)}`).catch(() => null);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
    Card,
    {
      ...
      right: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "text-sm text-zinc-500", children: cam.label || id }),
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "mt-1 text-sm text-zinc-400", children: "Red and blue multipliers, with green as the reference. Both sensors read green high \u2014 two of every four photosites are green \u2014 so frames arrive with a green cast until these are set. RAW/DNG pixels are never changed; the multipliers are recorded in the file for your raw editor to apply." }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "mt-4 space-y-3", children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
            Slider,
            {
        ...
        !noFrame && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("figure", { className: "mt-4", children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
            "img",
            {
          ...
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("figcaption", { className: "mt-1 text-xs text-zinc-500", children: "The most recent frame, rendered with the settings above. Reduced resolution \u2014 judge colour, not focus." })
        ] }),
        noFrame && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "mt-4 rounded-lg bg-zinc-800/60 p-3 text-sm text-zinc-500", children: "No frame captured yet, so there is nothing to preview." }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("label", { className: "mt-4 flex items-start justify-between gap-3 text-sm", children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { children: [
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "text-zinc-300", children: "Let the camera set it" }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "mt-1 block text-xs text-zinc-500", children: "Measured every twentieth frame once the exposure has settled, and moved a fifth of the way each time so nothing passing can recolour a night. Moving either slider below turns this off \u2014 a value you set by hand should not be quietly overwritten." })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
            Toggle,
            {
              checked: cam.wb_auto ?? true,
              label: "Let the camera set it",
              onChange: (wb_auto) => onCamera({ wb_auto })
            }
          )
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "mt-4 flex flex-wrap gap-2", children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Button, { onClick: autoSeed, className: "flex-1", children: "Auto from current frame" }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
            Button,
            {
              onClick: () => setPending({ r: 1, b: 1 }),
              disabled: neutral,
              className: "flex-1",
              children: "Reset to neutral"
            }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
            Button,
            {
              ...
              children: dirty ? "Apply \u2014 takes effect from the next frame" : "Applied"
            }
          )
        ] }),
        suggestion?.error && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "mt-3 text-sm text-amber-400", children: "Couldn\u2019t read a frame from this camera to measure." }),
        suggestion && !suggestion.error && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("p", { className: "mt-3 text-sm text-zinc-500", children: [
          "Measured R ",
          suggestion.means.r,
          " / G ",
          suggestion.means.g,
          ...
          suggestion.means.b,
          ", suggesting ",
          suggestion.raw_r.toFixed(2),
          " and",
          " ",
          suggestion.raw_b.toFixed(2),
          ".",
          suggestion.clamped ? " That is beyond the slider range and has been limited \u2014 worth checking the lens and lighting before accepting it." : " A starting point: it assumes the scene averages to grey, so adjust from here on what you can see."
        ] })
      ]
    }
  );
...
function RawCard({ raw, storage, onRaw }) {
  ...
  const cost = storage?.nights_remaining != null && storage?.per_night_gb ? `About ${storage.nights_remaining} more nights at the current rate (${storage.per_night_gb} GB/night${storage.basis === "in_progress" ? ", measured from tonight so far" : ""}).` : null;
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(Card, { title: "RAW (DNG)", children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "mt-1 text-sm text-zinc-400", children: "Full sensor data beside each JPEG, for editing keepers in Lightroom, Siril or PixInsight. Roughly 25 MB per frame \u2014 far larger than a JPEG." }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "mt-4 space-y-3", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
        Select,
        {
      ...
      mode === "every_nth" && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
        NumberField,
        {
          label: "Every",
          suffix: "frames",
      ...
      mode === "window" && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "space-y-3 rounded-xl bg-zinc-800/40 p-4", children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
          TimeField,
          {
            label: "From",
            value: raw.window_start ?? "22:00",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
          ...
          {
            label: "Until",
            value: raw.window_end ?? "02:00",
            onChange: (window_end) => onRaw({ window_end })
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "text-xs text-zinc-500", children: "Local time. A window that ends before it starts is read as crossing midnight." })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
        NumberField,
        {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "-mt-1 text-xs text-zinc-500", children: "How many recent frames are held in memory for the dashboard\u2019s Save RAW button. Deeper costs RAM: about 25 MB per frame." }),
      mode === "every_frame" && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(EnduranceWarning, { storage }),
      mode !== "off" && cost && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "rounded-lg bg-zinc-800/60 p-3 text-xs text-zinc-400", children: cost })
    ] })
  ] });
}
var RUNNING_STATES = ["waiting", "running", "rolling_back"];
function UpdateCard({ cfg, showToast, onChannel, onAutoCheck }) {
  ...
  const load = (0, import_react3.useCallback)(async (force) => {
    try {
  ...
  const apply = async (now) => {
    try {
      ...
      else showToast(now ? "Updating now \u2014 services will restart" : "Update queued for the next daytime window");
    } catch {
      showToast("Could not start the update");
    }
  };
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
    ...
    {
      title: "Updates",
      right: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: "text-sm text-zinc-500", children: [
        "v",
        info?.current ?? "\u2014"
      ] }),
      children: [
        info?.error ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "mt-1 text-sm text-amber-400", children: info.error }) : info && info.auto_check === false && !info.checked_at ? (
          /* Never say "up to date" about a check that has not happened. */
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "mt-1 text-sm text-zinc-400", children: "Not checked. Press Check now when you want to look." })
        ) : info?.available ? /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "mt-1 text-sm text-sky-300", children: channel === "dev" ? `${info.commits_behind} commit${info.commits_behind === 1 ? "" : "s"} behind main (${info.latest})` : `Version ${info.latest} is available` }),
          info.notes && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("pre", { className: "mt-3 max-h-40 overflow-auto whitespace-pre-wrap rounded-lg\r\n                            bg-zinc-800/60 p-3 text-xs text-zinc-400", children: info.notes })
        ] }) : /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "mt-1 text-sm text-zinc-400", children: "Up to date." }),
        progress && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "mt-3 rounded-lg bg-zinc-800/60 p-3 text-sm", children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: progress.state === "error" ? "text-rose-400" : progress.state === "rolled_back" ? "text-amber-300" : "text-zinc-300", children: progress.message ?? progress.state }),
          progress.prior && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("p", { className: "mt-1 text-xs text-zinc-500", children: [
            "Previous build ",
            progress.prior,
            " kept for rollback"
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "mt-4 flex gap-3", children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Button, { onClick: recheck, disabled: checking, children: checking ? "Checking\u2026" : "Check now" }),
          info?.available && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
              Button,
              {
                ...
                onClick: () => apply(false),
                disabled: busy,
                children: "Update at next daytime"
              }
            ),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Button, { onClick: () => apply(true), disabled: busy, children: "Now" })
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("label", { className: "mt-4 flex items-start justify-between gap-3 text-sm", children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { children: [
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "text-zinc-300", children: "Check automatically" }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "mt-1 block text-xs text-zinc-500", children: "Look for a new version once a day. Turn it off and the camera only asks when you press Check now." })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
            Toggle,
            {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("label", { className: "mt-4 flex items-start justify-between gap-3 text-sm", children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { children: [
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "text-zinc-300", children: "Development channel" }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "mt-1 block text-xs text-zinc-500", children: "Follow the latest commit on main instead of tagged releases. For development units \u2014 expect rough edges." })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
            Toggle,
            {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "mt-3 text-xs text-zinc-500", children: "Updates Skylapse only \u2014 never the operating system. If the camera doesn\u2019t come back healthy within a minute, the previous version is restored automatically." })
      ]
    }
  );
}
function EnduranceWarning({ storage }) {
  ...
  const rate = gb ? `~${gb} GB per night${measured ? "" : " (estimated)"}` : "~30+ GB per night";
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "rounded-lg border border-amber-700/60 bg-amber-950/40 p-3", children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
      "button",
      {
        onClick: () => setOpen(!open),
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "flex-1", children: open ? "Heads up: heavy sustained writes" : `Heavy sustained writes \u2014 ${rate}` }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "shrink-0 text-xs text-amber-500/80", children: open ? "Hide" : "Details" })
        ]
      }
    ),
    open && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "mt-2 space-y-2 text-xs text-amber-200/80", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("p", { children: [
        "Saving every frame as RAW writes ",
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("strong", { children: rate }),
        frames ? ` (${frames.toLocaleString()} frames at ` : "",
        frames ? `${Math.round((storage.raw_bytes_per_frame ?? 0) / 1e6)} MB each)` : "",
        partial && " \u2014 measured from tonight so far, so a full night will be more",
        ". On a microSD card this is heavy sustained wear; cards can fail suddenly after months of it."
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { children: "Recommended: a high-endurance SD card or a USB SSD for the image store, and keep a config backup off the camera (Settings \u2192 Download config, or automatically with every USB export) so recovery is quick if the card does die." })
    ] })
  ] });
}
function TimeField({ label, value, onChange }) {
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("label", { className: "flex items-center justify-between gap-3 text-sm", children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "text-zinc-400", children: label }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
      "input",
      {
        type: "time",
...
try {
  (0, import_server.renderToString)(import_react4.default.createElement(SettingsScreen, {
    showToast: () => {
    },
    storage: { free_gb: 200 }
  }));
